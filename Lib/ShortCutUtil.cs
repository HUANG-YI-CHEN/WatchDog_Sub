...
namespace WatchDog.Lib
{
    public class ShortCutUtil
    {
        ...
        /// Create 建立捷徑
        /// </summary>
        /// <param name="srcFilePath">執行檔絕對路徑</param>
        /// <param name="dstFolderPath">捷徑輸出資料夾路徑</param> 
        /// <param name="args">參數</param>
        public static bool ShortCutCreate(string srcFilePath, string dstFolderPath, string args = "")
        {
            bool flag = true;
            ShellLink shortcut;
            try
            {
                if (File.Exists(srcFilePath))
                {
                    ...
                    else
                    {
                        ...
                        shortcut.Save(dstFolderPath + @"\" + fileName + "_" + GetNow.ToString("yyyyMMddHHmmss") + ".lnk");
                    }
                    shortcut.Dispose();
                }
        ...
        private static void ShortCutCreateOld(string linkFileName, string args = "")
        {
